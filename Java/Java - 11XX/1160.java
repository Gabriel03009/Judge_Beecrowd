...
cuja taxa de crescimento da cidade A é maior do que a taxa de crescimento da cidade B, portanto, 
...
class Main {
    public static void main(String[] args) {
        ...
        double t, pa, pb, g1, g2, contador, a, b;
        ...
        for(int i = 0; i < t; i++){
            pa = in.nextDouble();
            pb = in.nextDouble();
            g1 = in.nextDouble() / 100;
            g2 = in.nextDouble() / 100;
            contador = 0;
